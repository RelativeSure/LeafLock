...
**Default**: `development`
**Example**: `production`
**Description**: Environment mode. When set to `development`, automatically allows `*.railway.app` origins for PR testing. Production mode requires explicit `CORS_ORIGINS` configuration.
