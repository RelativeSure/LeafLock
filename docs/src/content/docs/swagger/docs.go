...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/handlers.ExportDataResponse"
                        }
                    },
                    "401": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/handlers.Announcement"
                            }
                        }
                    },
                    "401": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/auth.MFASetupResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/auth/mfa/enable": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "TOTP code and secret",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/auth/mfa/verify": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "MFA code and session token",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/auth.PasswordResetConfirm"
                        }
                    }
                ],
                "responses": {
        ...
        "/notes/{id}/collaborators/{userId}": {
            "delete": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid note ID or user ID",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "404": {
                        "description": "Note not found or collaboration not found",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/notes/{id}/share-links": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Share link configuration",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.CreateShareLinkRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/notes/{id}/versions": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "List of note versions",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/notes/{id}/versions/{version}/restore": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "Note restored to version",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "400": {
                        "description": "Invalid note ID or version",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
    ...
    "definitions": {
        ...
        "handlers.CreateShareLinkRequest": {
            ...
            "properties": {
                "expires_in": {
                    "description": "\"1h\", \"24h\", \"7d\", \"30d\", or null for never",
                    "type": "string"
                },
                "max_uses": {
