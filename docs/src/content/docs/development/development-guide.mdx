...
CI executes the same targets inside `.github/workflows/e2e-verify.yml` before publishing container images. Keep the pipeline green and updates sail through 🚀.
