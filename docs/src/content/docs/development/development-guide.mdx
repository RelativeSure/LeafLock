...
CI executes the same targets inside `.github/workflows/ci-app-e2e.yml` before publishing container images. Keep the pipeline green and updates sail through 🚀.
