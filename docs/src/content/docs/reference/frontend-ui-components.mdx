...
This ensures:
- ✅ Latest official components from shadcn.com
- ✅ Automatic dependency installation
- ✅ Correct TypeScript types
- ✅ Proper Radix UI primitive versions
...
A secure, WYSIWYG-only editor used in Notes.

- Features: bold, italic, strikethrough, inline code, H1–H3 headings, bulleted/numbered lists, quote, links, images (URL), code block, horizontal rule, drag-and-drop attachments, history.
- Security: output HTML is sanitized; data is encrypted before API send.
...
✅ **Focus management** - Focus trap in modals, focus rings
✅ **Screen reader support** - Semantic HTML, live regions
✅ **Color contrast** - WCAG AA compliant color tokens
...
- ✅ **Skeleton** - Loading states for notes, components
- ✅ **Card** - Dialogs, overlays, settings panels
- ✅ **Toaster** - Global toast notifications
- ✅ **Button, Input, Label** - Forms throughout app
- ✅ **Alert** - Error/success messages
- ✅ **Badge** - Status indicators, tags
- ✅ **Dialog** - Modals for confirmations
- ✅ **Select, Switch** - Settings controls

### Planned Refactors

🔲 **SearchBar** → `Command` + `Dialog` for command palette
🔲 **TagsManager** → `Sheet` for slide-out panel
🔲 **FoldersManager** → `Sheet` with `Form` components
🔲 **Settings menus** → `DropdownMenu` for user actions
🔲 **Import/Export** → `Tabs` for different formats
