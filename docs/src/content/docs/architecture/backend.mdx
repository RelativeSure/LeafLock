...
middleware.JWTMiddleware(...)  // Validates JWT + Redis session
...
<Aside type="caution">
WebSocket traffic bypasses HTTP CSRF checks—authorization depends entirely on JWT validation and database membership.
</Aside>
