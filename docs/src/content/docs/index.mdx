...
**Stack**: Go 1.23 backend (Fiber), React 19 frontend (TypeScript, Vite, TanStack Query), PostgreSQL 15, Redis 7
...
<CardGrid stagger>
  <Card title="Encryption Architecture" icon="approve-check">
    ...
    [Read more →](/architecture/encryption/)
  </Card>
...
**Authentication**: Clerk integration for modern user management

## Features

- Client-side encryption (XChaCha20-Poly1305, 256-bit keys)
- Password hashing (Argon2id, 64MB memory)
- Clerk authentication with enterprise-grade security and MFA
...
- [Encryption Technical Details](/architecture/encryption/)
