...
<Card title="🔧 Auto-Admin Creation" icon="setting">
**When it happens:**
...
<CardGrid>
  <Card title="📊 User Counts" icon="document">
    ```sql
    -- Total users
  ...
  <Card title="💾 Storage Usage" icon="laptop">
    ```sql
    -- Storage by user
    SELECT
        id,
...
<Card title="🔓 Unlock Locked Accounts" icon="approve-check">
**Single user:**
```sql
UPDATE users
...
<Card title="📝 New User Registration" icon="add-user">
```bash
...
<CardGrid>
  <Card title="🚫 Cannot Login" icon="error">
  ...
  <Card title="🔑 Lost Admin Access" icon="warning">
...
**⚠️ DANGER**: This permanently deletes ALL user data!
...
<CardGrid>
  ...
  <Card title="⚙️ System Settings" icon="setting">
    - Global application configuration
    - User registration settings
    - Security policy management
    - System announcements
  </Card>
  <Card title="📋 Audit Logs" icon="list-format">
    - User login attempts
    - Permission changes
    - Security events
...
<Card title="🔒 Zero-Knowledge Architecture" icon="lock">
