...
Keep the [Environment variables](/getting-started/environment-variables/) doc handy for required secrets and port mapping.

## After Deploying

- Walk through the short [Readiness checklist](./readiness-checklist/)
