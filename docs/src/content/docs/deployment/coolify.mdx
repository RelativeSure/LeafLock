...
description: Deploy LeafLock on a self-hosted Coolify 4.x instance using the provided Docker Compose setup.
---

LeafLock ships with a `docker-compose.coolify.yml` that Coolify understands out of the box. Use this guide to get the app online without duplicating information that already lives in other docs.
