...
description: Lightweight checklist you can run through before promoting LeafLock to production.
---
...
If something fails, jump to the relevant deployment guide or the [Troubleshooting section](/troubleshooting/). Keep the checklist short and factual so it never turns into busywork.
