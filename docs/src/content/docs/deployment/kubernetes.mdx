---
title: Kubernetes
description: Deploy LeafLock on Kubernetes with Helm, ingress controllers, and production-ready configuration.
---
...
<Card title="☸️ Cloud-Native Architecture" icon="setting">
...
<CardGrid>
  <Card title="☸️ Kubernetes Cluster" icon="rocket">
    - Kubernetes 1.24+ cluster
    - kubectl configured
    - Cluster admin permissions
    - LoadBalancer support (cloud provider)
  </Card>
  <Card title="📦 Additional Tools" icon="laptop">
...
<Card title="🗄️ PostgreSQL StatefulSet" icon="document">
...
<Card title="⚡ Go Backend Deployment" icon="rocket">
**Deployment Features:**
...
<Card title="🌐 Ingress Controller Setup" icon="setting">
...
<Card title="📈 Auto-Scaling Setup" icon="rocket">
**HPA Configuration:**
...
<Card title="📦 Helm Deployment Process" icon="rocket">
...
<Card title="📊 Monitoring Stack" icon="list-format">
...
<Card title="💾 Backup Strategy" icon="document">
**Backup Components:**
...
<CardGrid>
  <Card title="🔌 Pod Connectivity" icon="warning">
  ...
  <Card title="📊 Resource Issues" icon="error">
