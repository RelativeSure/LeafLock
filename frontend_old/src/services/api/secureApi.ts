...
import type { AuthResponse, Note } from '@/types/auth'
import type { ThemeType } from '@/context/ThemeContext'
import { getStoredAuthToken, persistAuthToken, clearStoredAuthToken } from '@/utils/auth'
import { cryptoService, type CryptoService } from '@/services/crypto/cryptoService'
import type { UseTemplateRequest, UseTemplateResponse } from '@/services/data/templatesService'
