...
describe('Integration: Search and Filter Flow', () => {
  ...
  beforeEach(() => {
    useNotesStore.setState({
      ...
      tags: [
        { id: 'tag-1', name: 'work', color: '#ff0000', userId: 'user-1' },
        { id: 'tag-2', name: 'meeting', color: '#00ff00', userId: 'user-1' },
        { id: 'tag-3', name: 'personal', color: '#0000ff', userId: 'user-1' },
        { id: 'tag-4', name: 'tasks', color: '#ffff00', userId: 'user-1' },
        { id: 'tag-5', name: 'ideas', color: '#ff00ff', userId: 'user-1' },
      ],
      selectedNote: null,
      selectedFolder: null,
    })
