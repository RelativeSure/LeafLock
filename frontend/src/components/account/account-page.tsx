 ...
 *
 * Purpose: Dedicated account management page with collapsible sidebar navigation.
 * Provides focused interface for managing user profile, security settings,
 * data backup/restore, and application preferences.
 *
 * Architecture:
 * - Collapsible sidebar with account-specific navigation
 * - Main content area with tabbed interface
 * - URL-based tab state management
 * - Consistent with main app sidebar behavior
 */
...
import { Database, Download, Lock, Bell } from 'lucide-react'
import {
  Select,
  SelectContent,
  SelectItem,
...
export function AccountPage() {
  ...
  const search = useSearch({ strict: false }) as AccountSearchParams
  ...
  return (
    ...
    >
      <Tabs
        value={activeTab}
        onValueChange={(value) => navigate({ to: '/account', search: { tab: value } })}
      >
        {renderProfileTab()}
        {renderBackupTab()}
        {renderSecurityTab()}
