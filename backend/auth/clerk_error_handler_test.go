...
func TestValidateClerkConfiguration(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			secretKey:   "sk_test_test_abcdef12345678901234567890",
			expectError: true,
